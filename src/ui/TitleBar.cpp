...
TitleBar::TitleBar(QWidget *parent) : QWidget(parent) {
  ...
  setMinimumHeight(qMax(30, calculatedHeight));
  setMaximumHeight(qMax(34, calculatedHeight + 4));
  ...
  m_appIconLabel->setPixmap(QIcon(":/icons/app_icon.ico").pixmap(18, 18));
  m_appIconLabel->setFixedSize(18, 22);
  ...
  m_githubBtn->setIconSize(QSize(14, 14));
  m_githubBtn->setFixedSize(22, 22);
  ...
  m_donateBtn->setIconSize(QSize(14, 14));
  m_donateBtn->setFixedSize(22, 22);
  ...
  m_minimizeBtn->setIconSize(QSize(11, 11));
  m_minimizeBtn->setToolTip("Minimize");
  m_minimizeBtn->setFixedSize(30, 24);
